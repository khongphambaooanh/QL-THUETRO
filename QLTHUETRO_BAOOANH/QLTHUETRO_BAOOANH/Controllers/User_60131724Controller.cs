...
{
    public class User_60131724Controller : Controller
    {
        ...
        public ActionResult Register(User _user)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ViewBag.error = "Email đã đăng ký, vui lòng sử dụng email khác!";
                    return View();
                }
            }
            return View();
        ...
        public ActionResult Logout()
        {
            ...
            return RedirectToAction("Index", "Trangchu_60131724");
        }
        ...
        // GET: User_60131724/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: User_60131724/Create
